# Simple copy from torch.nn.modules.utils and torch.nn.common_types
import collections
...
def _ntuple(n: int, name="parse"):
    """Code generator for expanding tuple."""

    def parse(x: T | U) -> U:
        # Weird generic typing but good type hint result
